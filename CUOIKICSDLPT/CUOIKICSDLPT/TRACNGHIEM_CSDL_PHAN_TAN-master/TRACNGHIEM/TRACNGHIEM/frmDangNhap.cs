    ...
    public partial class frmDangNhap : Form
    {
        ...
        private void frmDangNhap_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string chuoiketnoi = "Data Source=ADMIN;Initial Catalog=TracNghiem;Integrated Security=True";
            ...
            {
                MessageBox.Show("Không thể kết nối tới database SSSSSS! " + a.Message, "", MessageBoxButtons.OK);
            }
        }
